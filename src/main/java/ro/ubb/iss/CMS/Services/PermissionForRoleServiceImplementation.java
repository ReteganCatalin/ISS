...
public class PermissionForRoleServiceImplementation implements PermissionForRoleService {
  ...
  @Autowired PermissionForRoleRepository permissionForRoleRepository;

  @Override
  public Optional<PermissionForRole> findPermissionForRole(
      PermissionForRoleKey permissionForRoleKey) {
    log.trace(
        "findPermissionForRole - method entered permissionForRoleKey={}", permissionForRoleKey);
  ...
  @Override
  public Optional<PermissionForRole> savePermissionForRole(
      PermissionForRoleKey permissionForRoleKey) {
    log.trace(
    ...
    checkForPresence.ifPresentOrElse(
        analysis -> {}, () -> permissionForRoleRepository.save(newPermissionForRole));
  ...
  public void deletePermissionForRole(PermissionForRoleKey permissionForRoleKey) {
    log.trace(
        "deletePermissionForRole - method entered: permissionForRoleKey={}", permissionForRoleKey);
