...
public class ConferenceProposalServiceImplementation implements ConferenceProposalService {
  ...
  @Autowired ConferenceProposalRepository conferenceProposalRepository;

  @Override
  public Optional<ConferenceProposal> findConferenceProposal(
      ConferenceProposalKey conferenceProposalKey) {
    log.trace(
        "findConferenceProposal - method entered conferenceProposalKey={}", conferenceProposalKey);
    Optional<ConferenceProposal> result =
        conferenceProposalRepository.findById(conferenceProposalKey);
  ...
  @Override
  public Optional<ConferenceProposal> saveConferenceProposal(
      ConferenceProposalKey conferenceProposalKey) {
    log.trace(
        "saveConferenceProposal - method entered: conferenceProposalKey={}", conferenceProposalKey);
    ConferenceProposal newConferenceProposal =
        ConferenceProposal.builder().conferenceProposalKey(conferenceProposalKey).build();
    Optional<ConferenceProposal> checkForPresence =
        conferenceProposalRepository.findById(conferenceProposalKey);

    checkForPresence.ifPresentOrElse(
        analysis -> {}, () -> conferenceProposalRepository.save(newConferenceProposal));
  ...
  public void deleteConferenceProposal(ConferenceProposalKey conferenceProposalKey) {
    log.trace(
        "deleteConferenceProposal - method entered: conferenceProposalKey={}",
