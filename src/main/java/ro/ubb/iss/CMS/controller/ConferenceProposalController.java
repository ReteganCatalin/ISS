...
public class ConferenceProposalController {
  ...
  @Autowired private ConferenceProposalService service;
  ...
  public ConferenceProposalDto getConferenceProposal(
    ...
    Optional<ConferenceProposal> conferenceProposal =
        service.findConferenceProposal(conferenceProposalKey);
  ...
  public ResponseEntity<?> deleteConferenceProposal(
      @PathVariable Integer proposalId, @PathVariable Integer conferenceId) {
    log.trace(
        "deleteConferenceProposal - method entered: proposalId={}, conferenceId={}",
        proposalId,
        conferenceId);
    ConferenceProposalKey conferenceProposalKey =
        ConferenceProposalKey.builder().proposalID(proposalId).conferenceID(conferenceId).build();
