...
public class QualifierController {
  ...
  public ResponseEntity<QualifiersDto> getAllQualifiers() {
  ...
  public ResponseEntity<QualifierDto> getQualifier(@PathVariable Integer id) {
  ...
  public ResponseEntity<QualifierDto> saveQualifier(@RequestBody QualifierDto qualifierDto) {
  ...
  public ResponseEntity<QualifierDto> updateQualifier(@RequestBody QualifierDto qualifierDto) {
