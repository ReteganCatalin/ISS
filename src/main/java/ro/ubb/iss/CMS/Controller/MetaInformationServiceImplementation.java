...
public class MetaInformationServiceImplementation implements MetaInformationService {
    ...
    private static final Logger log = LoggerFactory.getLogger(MetaInformationServiceImplementation.class);

    @Autowired
    MetaInformationRepository metaInformationRepository;
    ...
    @Override
    @Transactional
    public MetaInformation updateMetaInformation(int metaInfoID, String name, String keywords, String topics) {
        log.trace("updateMetaInformation - method entered: metaInfoID={}, name={}, keywords={},topics={}",metaInfoID,name,keywords,topics);

        Optional<MetaInformation> metaInformationOptional = metaInformationRepository.findById(metaInfoID);
    ...
    public MetaInformation saveMetaInformation(String name, String keywords, String topics) {
        log.trace("saveMetaInformation - method entered: name={}, keywords={},topics={}",name,keywords,topics);
        MetaInformation newMetaInformation = MetaInformation.builder().name(name).keywords(keywords).topics(topics).build();
