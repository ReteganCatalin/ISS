...
public class UserServiceImplementation implements UserService{
    ...
    @Override
    public User updateUser(int userID, String username, String password, boolean isValidated, UserInfo userInfoID) {
        log.trace("updateUser - method entered: userID={}, username={}, password={}, isValidated={}, userInfoID={}", userID,username,password,isValidated,userInfoID);
    ...
    public User saveUser(String username, String password, boolean isValidated, UserInfo userInfoID) {
        log.trace("saveUser - method entered: username={}, password={}, isValidated={}, userInfoID={}", username,password,isValidated,userInfoID);
        User newUser = User.builder().username(username).password(password).isValidated(isValidated).userInfo(userInfoID).build();
